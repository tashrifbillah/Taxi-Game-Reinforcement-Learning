    ...
    while delta>tol and j<max_iteration:
        ...
        for s in range(env.nS):
            ...
            for a in range(env.nA):
                ...
                if maximum < env.P[s][a][0][reward] + gamma *V[env.P[s][a][0][nextstate]]:
                    maximum = env.P[s][a][0][reward] + gamma *V[env.P[s][a][0][nextstate]]
                    V[s] = maximum
...
if __name__ == "__main__":
    ...
    print('Score')
    print(scores)
    print("---Value iteration execution time: %s seconds ---" % (time.time() - start_time))
